...
<section class="mx-auto max-w-7xl px-5 py-16 lg:px-8">
	<ScrollReveal delay={100} direction="up">
		<div
			class="group relative grid overflow-hidden rounded-[2rem] border border-foreground/10 bg-foreground p-8 text-background md:p-10 lg:grid-cols-[1fr_auto] gap-8"
		>
			<div
